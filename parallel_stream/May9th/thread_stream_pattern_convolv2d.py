...
def mkLed():
    ...
    out_size = 3
    loop_size = 10
    # 0, 1, 2, 3, 100, 101, 102, 103, 200, 201, 202, 203, 1000, 1001, 1002, 1003, 1100, 1101, 1102, 1103, 1200, 1201, 1202, 1203, 2000, 2001, 2002, 2003, 2100, 2101, 2102, 2103, 2200, 2201, 2202, 2203, 
    # pattern_b = ((klen, 1), (out_size, 100), (loop_size), 1000)
    pattern_b = ((klen // 2, 1), (out_size, 100), (loop_size), 1000)
    offset_k = 0
    ...
    for k in range(loop_size):
        ...
        for j in range(out_size):
            ...
            for i in range(klen // 2):
                # addr = offset_i + offset_j + offset_k
                addr0 = offset_i + offset_j + offset_k
                addr1 = offset_i + offset_j + offset_k + 1
                # offset_i += 1
                offset_i += 1 * 2
            offset_j += 100
        offset_k += 1000
