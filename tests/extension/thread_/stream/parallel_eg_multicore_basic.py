...
def mkLed():
    ...
    sum = sum1 + sum2
    strm.sink(sum, 'sum', when=strm.Land(sum_valid1, sum_valid2), when_name='sum_valid1')
    # Timer
    ...
    def comp_stream(size, offset):
        ...
        # strm.set_source_parallel_pattern('a1', ram_a, offset, (para, size)) #how to set start address
...
# record: multiple ram, broadcast or just several ports